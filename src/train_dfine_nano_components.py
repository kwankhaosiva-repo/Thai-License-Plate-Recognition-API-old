"""
src/train_dfine_nano_components.py

Fine-tunes D-FINE Nano (MIT License) for Model 2 Component Detection.
Classes: plate_char, province (2 classes).
Saves weights to weights/component_detector_dfine_nano.pt and .onnx.
"""
...
TARGET_WEIGHTS_PATH = OUTPUT_WEIGHTS_DIR / "component_detector_dfine_nano.pt"
TARGET_ONNX_PATH    = OUTPUT_WEIGHTS_DIR / "component_detector_dfine_nano.onnx"
RUNS_DIR            = PROJECT_ROOT / "runs" / "train_dfine_nano" / "components"
...
def train_dfine_nano_components(epochs=30, batch=8, imgsz=640, patience=12, device="mps", export_onnx=True):
    print("=" * 70)
    print("🚀 D-FINE Nano Training — Model 2 (Component Detection)")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train D-FINE Nano for Model 2 (Component Detection)")
