"""
src/train_rfdetr_small_charbox.py

Fine-tunes RF-DETR-Small (Apache-2.0 License) for Model 3A Character Box Detection.
Saves weights to weights/character_box_detector_rfdetr_small.pt.
"""
...
TARGET_WEIGHTS_PATH = OUTPUT_WEIGHTS_DIR / "character_box_detector_rfdetr_small.pt"
RUNS_DIR            = PROJECT_ROOT / "runs" / "train_rfdetr_small" / "charbox"


def train_rfdetr_small_charbox():
    print("=" * 70)
    print("🚀 RF-DETR-Small Training — Model 3A (Character Box Detection)")
