"""
src/train_rfdetr_small_lao_plate.py

Fine-tunes RF-DETR-Small (Apache-2.0 License) for Lao Plate Detection.
Saves weights to weights/plate_detector_lao_rfdetr_small.pt.
"""
...
TARGET_WEIGHTS_PATH = OUTPUT_WEIGHTS_DIR / "plate_detector_lao_rfdetr_small.pt"
RUNS_DIR            = PROJECT_ROOT / "runs" / "train_rfdetr_small" / "lao_plate"


def train_rfdetr_small_lao_plate():
    print("=" * 70)
    print("🚀 RF-DETR-Small Training — Lao Plate Detection")
